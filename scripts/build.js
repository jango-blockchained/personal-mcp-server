 ...
 * This script avoids ESM import issues by using child_process to run tsup
 */
...
try {
	...
	execSync(
		`${hasTsupLocal ? nodeModulesPath : 'npx tsup'} src/index.ts src/bin.ts --format cjs,esm --dts --clean --sourcemap`,
		{
			cwd: rootDir,
